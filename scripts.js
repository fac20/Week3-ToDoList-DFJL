...
const addTemplate = () => {
  ...
  let section = document.querySelector(`.${time.value}`); // select the unordered list in the relevant section related to the time argument
...
document.addEventListener("click", (e) => {
  ...
  if (e.target.className === "delete-button") {
    //if the item clicked has a class of 'delete-button'
